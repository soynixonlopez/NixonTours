...
export function SelectNative({
  ...
  return (
    <select
      className={cn(
        "flex h-11 w-full appearance-none rounded-2xl border border-slate-200 bg-brand-pearl px-3 py-2 pr-10 text-sm text-slate-800 outline-none transition",
        "focus-visible:border-brand-turquoise focus-visible:ring-2 focus-visible:ring-brand-turquoise/25",
